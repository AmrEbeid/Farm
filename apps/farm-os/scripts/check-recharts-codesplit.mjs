...
const ALLOWED_CHART_ROUTES = [
  ...
  // The canonical income-statement route includes the revenue/cost/net trend + cumulative J-curve view;
  // Recharts stays in this route's own client chunk, never the global bundle.
  "/finance/income-statement/page",

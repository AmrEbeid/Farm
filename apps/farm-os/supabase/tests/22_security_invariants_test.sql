  ...
  (select count(*)::int
    ...
    where n.nspname = 'public'
      ...
      and p.proname not in (
        ...
        'fn_save_account', 'fn_archive_account',   -- gated COA-tree RPCs (SPEC-0024 S-1, migration 20260701430000)
        'fn_merge_accounts', 'fn_set_expense_account' -- gated COA merge + expense→account classification (SPEC-0024 A.5)

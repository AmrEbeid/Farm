  ...
  (select count(*)::int
    ...
    where n.nspname = 'public'
      ...
      and p.proname not in (
        ...
        'fn_save_academy_content', 'fn_signoff_academy_content', -- gated Care Academy RPCs (STAGE 10 / SPEC-0008, migration 0089)
        'fn_archive_academy_content'               -- gated Care Academy RPC (STAGE 10 / SPEC-0008, migration 0089)

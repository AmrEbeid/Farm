...
export const WHY_BY_CODE: Record<string, WhyEntry> = {
  ...
  "55000": {
    code: "55000",
    explanation: "التاريخ يقع داخل فترة محاسبية مقفلة، لذلك لا يُسمح بترحيل قيد جديد عليها.",
    next: "اختر تاريخًا خارج الفترة المقفلة، أو اطلب من المالك إعادة فتح الفترة عند الحاجة.",
  },
  P0002: {
    code: "P0002",

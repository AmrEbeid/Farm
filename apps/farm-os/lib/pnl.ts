...
//
// The gated remainder (NOT here): the sales/vouchers/drawings tables + the transactional posting RPC +
// owner/accountant RLS + the REQUIRED independent review, and the **finance oracle** — the dual-run
// reconciliation of one closed season against the real 7-yr Excel (real data → Stage M / privacy review).

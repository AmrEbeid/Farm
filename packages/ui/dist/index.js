export { BarChart, DoughnutChart, LineChart, useChartTokens } from './chunk-OSSYTIVD.js';
...
function KpiCard({
  ...
  return /* @__PURE__ */ jsxs("div", { className: `fos-kpi ${className}`.trim(), ...rest, children: [
    ...
    delta != null && /* @__PURE__ */ jsxs("div", { className: `fos-kpi__delta${deltaDirection !== "none" ? ` fos-kpi__delta--${deltaDirection}` : ""}`, children: [
      deltaDirection !== "none" && /* @__PURE__ */ jsx("span", { className: "fos-kpi__delta-mark", "aria-hidden": "true", children: deltaDirection === "down" ? "\u26A0\uFE0E" : "\u2713" }),
...
function AppShell({
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      ...rest,
      children: [
        skipLink && /* @__PURE__ */ jsx("div", { className: "fos-appshell__background-slot", ...inertBackgroundProps, children: skipLink }),
        ...
        mobileNavigation && /* @__PURE__ */ jsx("div", { className: "fos-appshell__background-slot", ...inertBackgroundProps, children: mobileNavigation })
      ]
    }
  );
}

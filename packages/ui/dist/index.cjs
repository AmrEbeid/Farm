...
var chunkKK2N63NB_cjs = require('./chunk-KK2N63NB.cjs');
...
var Button = React22__namespace.forwardRef(function Button2({ variant = "primary", size = "md", loading = false, icon, disabled, children, className = "", ...rest }, ref) {
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "button",
    {
      ...
      ...rest,
      children: [
        loading && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "fos-btn__spinner", "aria-hidden": "true" }),
        !loading && icon,
        children
      ]
    }
...
function Tag({ tone = "neutral", children, className = "", ...rest }) {
  return /* @__PURE__ */ jsxRuntime.jsx("span", { className: `fos-tag fos-tag--${tone} ${className}`.trim(), ...rest, children });
}
function Card({ title, subtitle, children, className = "", ...rest }) {
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: `fos-card ${className}`.trim(), ...rest, children: [
    title != null && /* @__PURE__ */ jsxRuntime.jsx("h3", { className: "fos-card__title", children: title }),
    subtitle != null && /* @__PURE__ */ jsxRuntime.jsx("p", { className: "fos-card__sub", children: subtitle }),
    children
  ] });
}
function KpiCard({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: `fos-kpi ${className}`.trim(), ...rest, children: [
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "fos-kpi__label", children: [
      icon != null && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "fos-kpi__icon", "aria-hidden": "true", children: icon }),
      label
    ] }),
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "fos-kpi__value", children: [
      value,
      " ",
...
function Alert({ tone = "info", title, description, icon, className = "", ...rest }) {
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "div",
    {
      ...
      ...rest,
      children: [
        icon != null && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "fos-alert__icon", "aria-hidden": "true", children: icon }),
        /* @__PURE__ */ jsxRuntime.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntime.jsx("div", { className: "fos-alert__title", children: title }),
          description != null && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "fos-alert__desc", children: description })
        ] })
      ]
    }
  );
...
function Progress({ value, tone = "default", label, className = "", ...rest }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    "div",
    {
      ...
      "aria-label": label,
      ...rest,
      children: /* @__PURE__ */ jsxRuntime.jsx("span", { className: "fos-progress__bar", style: { width: `${pct}%` } })
    }
  );
}
function Field({ label, id, error, required, children, placeholder }) {
  ...
  if (children != null && React22__namespace.isValidElement(children) && (error || required)) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "fos-field", children: [
    /* @__PURE__ */ jsxRuntime.jsxs("label", { className: "fos-field__label", htmlFor: id, children: [
      label,
      required && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "fos-field__req", "aria-hidden": "true", children: " *" })
    ] }),
...
function VerdictBanner({ tone = "ok", icon, children, className = "", ...rest }) {
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { role: "status", className: `fos-verdict fos-verdict--${tone} ${className}`.trim(), ...rest, children: [
    /* @__PURE__ */ jsxRuntime.jsx("span", { "aria-hidden": "true", children: icon ?? DEFAULT_ICON[tone] }),
...
var IconButton = React22__namespace.forwardRef(function IconButton2({ label, variant = "ghost", size = "md", loading = false, disabled, children, className = "", ...rest }, ref) {
  return /* @__PURE__ */ jsxRuntime.jsx(
    "button",
    {
      ...
      "aria-busy": loading || void 0,
      ...rest,
      children: loading ? /* @__PURE__ */ jsxRuntime.jsx("span", { className: "fos-iconbtn__spinner", "aria-hidden": "true" }) : children
    }
  );
});
...
var NumberField = React22__namespace.forwardRef(function NumberField2({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: `fos-numfield ${className}`.trim(), "data-disabled": disabled || void 0, children: [
...
var Select = React22__namespace.forwardRef(function Select2({ options, placeholder, selectSize = "md", invalid, className = "", defaultValue, value, ...rest }, ref) {
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "select",
    {
      ...
      ...rest,
      children: [
        placeholder != null && /* @__PURE__ */ jsxRuntime.jsx("option", { value: "", disabled: true, children: placeholder }),
...
var Combobox = React22__namespace.forwardRef(function Combobox2({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: `fos-combobox ${className}`.trim(), children: [
    /* @__PURE__ */ jsxRuntime.jsx(
      "input",
      {
        ref,
    ...
    open && filtered.length > 0 && /* @__PURE__ */ jsxRuntime.jsx("ul", { className: "fos-combobox__list", role: "listbox", id: listId, children: filtered.map((o, i) => /* @__PURE__ */ jsxRuntime.jsx(
      "li",
      {
        id: `${baseId}-opt-${i}`,
        role: "option",
...
var Checkbox = React22__namespace.forwardRef(function Checkbox2({ label, invalid, id, disabled, className = "", ...rest }, ref) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("label", { className: `fos-checkbox ${className}`.trim(), "data-disabled": disabled || void 0, children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx("span", { className: "fos-checkbox__box", "aria-hidden": "true" }),
    /* @__PURE__ */ jsxRuntime.jsx("span", { className: "fos-checkbox__label", children: label })
  ] });
});
var uid3 = 0;
function RadioGroup({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "fieldset",
    {
      ...
      disabled,
      children: [
        /* @__PURE__ */ jsxRuntime.jsx("legend", { className: "fos-radiogroup__legend", children: legend }),
        options.map((o, i) => {
          const optId = `${groupId}-${i}`;
          return /* @__PURE__ */ jsxRuntime.jsxs("label", { className: "fos-radio", "data-disabled": o.disabled || void 0, htmlFor: optId, children: [
            /* @__PURE__ */ jsxRuntime.jsx(
              "input",
              {
                type: "radio",
            ...
            /* @__PURE__ */ jsxRuntime.jsx("span", { className: "fos-radio__dot", "aria-hidden": "true" }),
            /* @__PURE__ */ jsxRuntime.jsx("span", { className: "fos-radio__label", children: o.label })
          ] }, o.value);
        })
      ]
    }
...
var Switch = React22__namespace.forwardRef(function Switch2({ label, checked, defaultChecked, onCheckedChange, disabled, className = "", ...rest }, ref) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    "button",
    {
      ...
      onClick: toggle,
      ...rest,
      children: /* @__PURE__ */ jsxRuntime.jsx("span", { className: "fos-switch__thumb", "aria-hidden": "true" })
    }
  );
});
...
function Label({ required, children, className = "", ...rest }) {
  return /* @__PURE__ */ jsxRuntime.jsxs("label", { className: `fos-formrow__label ${className}`.trim(), ...rest, children: [
    children,
    required && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "fos-formrow__req", "aria-hidden": "true", children: " *" })
  ] });
}
function Help({ children, className = "", ...rest }) {
  return /* @__PURE__ */ jsxRuntime.jsx("div", { className: `fos-formrow__help ${className}`.trim(), ...rest, children });
}
function FieldError({ children, className = "", ...rest }) {
  return /* @__PURE__ */ jsxRuntime.jsx("div", { className: `fos-formrow__error ${className}`.trim(), role: "alert", ...rest, children });
}
function FormRow({ id, label, help, error, required, children }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "fos-formrow", children: [
    /* @__PURE__ */ jsxRuntime.jsx(Label, { htmlFor: id, required, children: label }),
    control,
    help != null && /* @__PURE__ */ jsxRuntime.jsx(Help, { id: helpId, children: help }),
    error != null && /* @__PURE__ */ jsxRuntime.jsx(FieldError, { id: errorId, children: error })
  ] });
}
function Stat({
  label,
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: `fos-stat ${className}`.trim(), ...rest, children: [
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "fos-stat__label", children: label }),
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "fos-stat__value", children: [
      value,
      unit != null && /* @__PURE__ */ jsxRuntime.jsx("small", { className: "fos-stat__unit", children: unit })
    ] }),
    change != null && /* @__PURE__ */ jsxRuntime.jsx("div", { className: `fos-stat__change fos-stat__change--${trend}`, children: change }),
...
function Timeline({ items, className = "", ...rest }) {
  return /* @__PURE__ */ jsxRuntime.jsx("ol", { className: `fos-timeline ${className}`.trim(), ...rest, children: items.map((item) => /* @__PURE__ */ jsxRuntime.jsxs("li", { className: "fos-timeline__item", children: [
    /* @__PURE__ */ jsxRuntime.jsx("span", { className: `fos-timeline__marker fos-timeline__marker--${item.tone ?? "default"}`, "aria-hidden": "true", children: item.icon }),
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "fos-timeline__body", children: [
      /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "fos-timeline__head", children: [
        /* @__PURE__ */ jsxRuntime.jsx("span", { className: "fos-timeline__title", children: item.title }),
        item.time != null && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "fos-timeline__time", children: item.time })
      ] }),
      item.description != null && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "fos-timeline__desc", children: item.description })
    ] })
  ] }, item.id)) });
}
function DescriptionList({ items, layout = "stacked", className = "", ...rest }) {
  return /* @__PURE__ */ jsxRuntime.jsx("dl", { className: `fos-dl fos-dl--${layout} ${className}`.trim(), ...rest, children: items.map((item) => /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "fos-dl__row", children: [
    /* @__PURE__ */ jsxRuntime.jsx("dt", { className: "fos-dl__dt", children: item.term }),
    /* @__PURE__ */ jsxRuntime.jsx("dd", { className: `fos-dl__dd${item.numeric ? " fos-dl__dd--num" : ""}`, children: item.description })
  ] }, item.id)) });
}
...
var Avatar = React22__namespace.forwardRef(function Avatar2({ name, src, size = "md", className = "", ...rest }, ref) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    "span",
    {
      ...
      "aria-label": name,
      ...rest,
      children: showImg ? /* @__PURE__ */ jsxRuntime.jsx("img", { className: "fos-avatar__img", src: safeSrc, alt: "", onError: () => setFailed(true) }) : /* @__PURE__ */ jsxRuntime.jsx("span", { className: "fos-avatar__initials", "aria-hidden": "true", children: initialsOf(name) })
    }
  );
});
var tooltipSeq = 0;
function Tooltip({ label, placement = "top", children }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("span", { className: "fos-tooltip", children: [
    trigger,
    open && /* @__PURE__ */ jsxRuntime.jsx("span", { role: "tooltip", id, className: `fos-tooltip__bubble fos-tooltip__bubble--${placement}`, children: label })
  ] });
}
function Pagination({
  page,
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("nav", { className: `fos-pagination ${className}`.trim(), "aria-label": ariaLabel, ...rest, children: [
    /* @__PURE__ */ jsxRuntime.jsx(
      "button",
      {
        type: "button",
    ...
    /* @__PURE__ */ jsxRuntime.jsx("ul", { className: "fos-pagination__list", children: pages.map((p) => /* @__PURE__ */ jsxRuntime.jsx("li", { children: /* @__PURE__ */ jsxRuntime.jsx(
      "button",
      {
        type: "button",
...
function EmptyState({ title, description, icon, action, className = "", ...rest }) {
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: `fos-empty ${className}`.trim(), ...rest, children: [
    icon != null && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "fos-empty__icon", "aria-hidden": "true", children: icon }),
    /* @__PURE__ */ jsxRuntime.jsx("p", { className: "fos-empty__title", children: title }),
    description != null && /* @__PURE__ */ jsxRuntime.jsx("p", { className: "fos-empty__desc", children: description }),
    action != null && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "fos-empty__action", children: action })
  ] });
}
function len(v) {
...
function Skeleton({
  ...
  if (shape === "text" && lines > 1) {
    return /* @__PURE__ */ jsxRuntime.jsx("span", { className: `fos-skeleton-group ${className}`.trim(), "aria-hidden": "true", ...rest, children: Array.from({ length: lines }, (_, i) => /* @__PURE__ */ jsxRuntime.jsx(
      "span",
      {
...
function ThemeProvider({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(ThemeContext.Provider, { value, children: /* @__PURE__ */ jsxRuntime.jsx("div", { className: `fos ${className}`.trim(), "data-theme": scheme, "data-density": density, "data-radius": radius, style, children }) });
}
...
function useOverlay({ open, onClose, closeOnEsc = true }) {
  ...
  const tokenRef = React22__namespace.useRef(/* @__PURE__ */ Symbol("overlay"));
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    Modal,
    {
      ...
      footer: /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
        /* @__PURE__ */ jsxRuntime.jsx(Button, { variant: "ghost", onClick: onClose, disabled: loading, children: cancelLabel }),
        /* @__PURE__ */ jsxRuntime.jsx(Button, { variant: tone === "danger" ? "danger" : "primary", loading, onClick: onConfirm, children: confirmLabel })
      ] }),
      children: description != null && /* @__PURE__ */ jsxRuntime.jsx("p", { className: "fos-confirm__desc", children: description })
    }
  );
}
...
function Toaster() {
  ...
  React22__namespace.useEffect(() => setMounted(true), []);
  ...
  return reactDom.createPortal(
    /* @__PURE__ */ jsxRuntime.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsx("div", { className: "fos-toaster", role: "status", "aria-live": "polite", "aria-atomic": "false", children: toasts.map((t) => /* @__PURE__ */ jsxRuntime.jsx(ToastItem, { toast: t, onDismiss: () => api.dismiss(t.id) }, t.id)) })
      }
    ),
    document.body
  );
...
function ToastItem({ toast, onDismiss }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { ref: elRef, className: `fos-toast fos-toast--${tone}`, children: [
    toast.icon != null && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "fos-toast__icon", "aria-hidden": "true", children: toast.icon }),
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "fos-toast__body", children: [
      /* @__PURE__ */ jsxRuntime.jsx("div", { className: "fos-toast__title", children: toast.title }),
      toast.description != null && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "fos-toast__desc", children: toast.description })
    ] }),
...
var NavItem = React22__namespace.forwardRef(function NavItem2({ item, active = false, onSelect, className = "", onClick, ...rest }, ref) {
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "a",
    {
      ...
      ...rest,
      children: [
        item.icon && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "fos-navitem__icon", "aria-hidden": "true", children: item.icon }),
        /* @__PURE__ */ jsxRuntime.jsx("span", { className: "fos-navitem__label", children: item.label })
      ]
    }
  );
});
function SidebarNav({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("nav", { className: `fos-sidebarnav ${className}`.trim(), "aria-label": ariaLabel, ...rest, children: /* @__PURE__ */ jsxRuntime.jsx("ul", { className: "fos-sidebarnav__list", children: visible.map((it) => /* @__PURE__ */ jsxRuntime.jsx("li", { className: "fos-sidebarnav__item", children: /* @__PURE__ */ jsxRuntime.jsx(NavItem, { item: it, active: it.id === activeId, onSelect }) }, it.id)) }) });
}
function Breadcrumbs({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("nav", { className: `fos-breadcrumbs ${className}`.trim(), "aria-label": ariaLabel, ...rest, children: /* @__PURE__ */ jsxRuntime.jsx("ol", { className: "fos-breadcrumbs__list", children: items.map((c, i) => {
    const isLast = i === items.length - 1;
    return /* @__PURE__ */ jsxRuntime.jsxs("li", { className: "fos-breadcrumbs__item", children: [
      isLast || !c.href ? /* @__PURE__ */ jsxRuntime.jsx("span", { className: "fos-breadcrumbs__current", "aria-current": isLast ? "page" : void 0, children: c.label }) : /* @__PURE__ */ jsxRuntime.jsx(
        "a",
        {
      ...
      !isLast && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "fos-breadcrumbs__sep", "aria-hidden": "true", children: separator })
    ] }, c.id);
  }) }) });
}
var uid4 = 0;
var SearchInput = React22__namespace.forwardRef(function SearchInput2({ label, value, onValueChange, icon, onSubmitSearch, className = "", id, onKeyDown, ...rest }, ref) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: `fos-search ${className}`.trim(), role: "search", children: [
    ...
    icon && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "fos-search__icon", "aria-hidden": "true", children: icon }),
    /* @__PURE__ */ jsxRuntime.jsx(
      "input",
      {
        ref,
...
function AppShell({
  ...
  const sidebarId = React22__namespace.useId();
  ...
  const onSidebarClick = React22__namespace.useCallback(
    (e) => {
      if (!open) return;
        ...
        /* @__PURE__ */ jsxRuntime.jsxs("header", { className: "fos-appshell__topbar", role: "banner", ...inertBackgroundProps, children: [
          /* @__PURE__ */ jsxRuntime.jsx(
            "button",
            {
              ...
              children: /* @__PURE__ */ jsxRuntime.jsx("span", { className: "fos-appshell__menu-icon", "aria-hidden": "true", children: menuIcon ?? "\u2630" })
            }
          ),
          brand && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "fos-appshell__brand", children: brand }),
          /* @__PURE__ */ jsxRuntime.jsx("div", { className: "fos-appshell__topbar-content", children: topbar })
        ] }),
        /* @__PURE__ */ jsxRuntime.jsx(
          "aside",
          {
            ...
            children: /* @__PURE__ */ jsxRuntime.jsx(
              "div",
              {
                ...
                children: sidebar ?? /* @__PURE__ */ jsxRuntime.jsx(
                  SidebarNav,
                  {
                    items: navItems,
...
function LoopStepper({ steps, ariaLabel, className = "", ...rest }) {
  return /* @__PURE__ */ jsxRuntime.jsx("ol", { className: `fos-loop ${className}`.trim(), "aria-label": ariaLabel, ...rest, children: steps.map((step, i) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(
      "li",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntime.jsx("span", { className: "fos-loopstep__marker", "aria-hidden": "true", children: state === "done" ? "\u2713" : state === "blocked" ? "!" : i + 1 }),
          /* @__PURE__ */ jsxRuntime.jsx("span", { className: "fos-loopstep__label", children: step.label })
        ]
      },
      step.id
    );
...
function PhaseCard({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: `fos-phase ${TONE_CLASS[tone]} ${className}`.trim(), ...rest, children: [
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "fos-phase__head", children: [
      /* @__PURE__ */ jsxRuntime.jsx("span", { className: "fos-phase__dot", "aria-hidden": "true" }),
      /* @__PURE__ */ jsxRuntime.jsx("span", { className: "fos-phase__title", children: title }),
      status != null && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "fos-phase__status", children: status })
    ] }),
    meta != null && meta.length > 0 && /* @__PURE__ */ jsxRuntime.jsx("dl", { className: "fos-phase__meta", children: meta.map((row, i) => /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "fos-phase__row", children: [
      /* @__PURE__ */ jsxRuntime.jsx("dt", { children: row.label }),
      /* @__PURE__ */ jsxRuntime.jsx("dd", { children: row.value })
    ] }, i)) }),
    progress != null && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "fos-phase__progress", children: /* @__PURE__ */ jsxRuntime.jsx(Progress, { value: progress, label: progressLabel }) })
  ] });
}
var STATUS_CLASS = {
...
function StatusPill({ status, dot = true, children, className = "", ...rest }) {
  return /* @__PURE__ */ jsxRuntime.jsxs("span", { className: `fos-pill ${STATUS_CLASS[status]} ${className}`.trim(), ...rest, children: [
    dot && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "fos-pill__dot", "aria-hidden": "true" }),
    children
  ] });
}
var STATUS_CLASS2 = {
...
function PalmCell({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    "button",
    {
      ...
      ...rest,
      children: glyph != null && /* @__PURE__ */ jsxRuntime.jsx("span", { "aria-hidden": "true", children: glyph })
    }
  );
}
function PalmGrid({ lines, ariaLabel, onCellActivate, className = "", ...rest }) {
  return /* @__PURE__ */ jsxRuntime.jsx("div", { className: `fos-palmgrid ${className}`.trim(), role: "group", "aria-label": ariaLabel, ...rest, children: /* @__PURE__ */ jsxRuntime.jsx("div", { className: "fos-palmgrid__scroll", children: lines.map((line) => /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "fos-palmgrid__line", children: [
    /* @__PURE__ */ jsxRuntime.jsx("span", { className: "fos-palmgrid__line-label", children: line.label }),
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "fos-palmgrid__cells", children: line.cells.map((cell) => /* @__PURE__ */ jsxRuntime.jsx(
      PalmCell,
      {
        status: cell.status,
...
function FileTimeline({ events, ariaLabel, className = "", ...rest }) {
  return /* @__PURE__ */ jsxRuntime.jsx("ol", { className: `fos-tl ${className}`.trim(), "aria-label": ariaLabel, ...rest, children: events.map((ev) => /* @__PURE__ */ jsxRuntime.jsxs("li", { className: `fos-tl__item ${KIND_CLASS[ev.kind]}`, children: [
    /* @__PURE__ */ jsxRuntime.jsx("span", { className: "fos-tl__marker", "aria-hidden": "true", children: ev.glyph }),
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "fos-tl__body", children: [
      /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "fos-tl__head", children: [
        /* @__PURE__ */ jsxRuntime.jsx("span", { className: "fos-tl__title", children: ev.title }),
        /* @__PURE__ */ jsxRuntime.jsx("time", { className: "fos-tl__time", children: ev.time })
      ] }),
      ev.description != null && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "fos-tl__desc", children: ev.description })
    ] })
  ] }, ev.id)) });
}
var STATE_CLASS2 = {
...
function ApprovalChain({ steps, ariaLabel, className = "", ...rest }) {
  return /* @__PURE__ */ jsxRuntime.jsx("ol", { className: `fos-approval ${className}`.trim(), "aria-label": ariaLabel, ...rest, children: steps.map((step) => /* @__PURE__ */ jsxRuntime.jsxs(
    "li",
    {
      className: `fos-approval__step ${STATE_CLASS2[step.state]}`,
      "aria-current": step.state === "pending" ? "step" : void 0,
      children: [
        /* @__PURE__ */ jsxRuntime.jsx("span", { className: "fos-approval__marker", "aria-hidden": "true", children: STATE_GLYPH[step.state] }),
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "fos-approval__body", children: [
          /* @__PURE__ */ jsxRuntime.jsx("span", { className: "fos-approval__actor", children: step.actor }),
          step.note != null && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "fos-approval__note", children: step.note })
        ] })
      ]
    },
    step.id
...
Object.defineProperty(exports, "BarChart", {
  enumerable: true,
  get: function () { return chunkKK2N63NB_cjs.BarChart; }
});
Object.defineProperty(exports, "DoughnutChart", {
  enumerable: true,
  get: function () { return chunkKK2N63NB_cjs.DoughnutChart; }
});
Object.defineProperty(exports, "LineChart", {
  enumerable: true,
  get: function () { return chunkKK2N63NB_cjs.LineChart; }
});
Object.defineProperty(exports, "useChartTokens", {
  enumerable: true,
  get: function () { return chunkKK2N63NB_cjs.useChartTokens; }
});
exports.Alert = Alert;
...
exports.FileTimeline = FileTimeline;
...
exports.PalmCell = PalmCell;
exports.PalmGrid = PalmGrid;

...
*Updated: 2026-07-04 (SPEC-0018-EXT custody report pack live). Owner: Amr Ebeid.*
...
| 7 Accounting | 86% | GL kernel + custody/payment requests live (#568/#468); atomic custody holder transfer live (#674, prod `20260701480000`); custody report pack live at `/finance/custody-reports` (#675, prod `20260701490000`); COA tree backend+UI + default farm COA live (#654/#661, prod `20260701440000`); cost centers + reports/insights live (#659/#667/#670); offshoot bank backend+UI live (#663/#672); finance dashboard separates accountant custody/payment-request due work (#673). No revenue/A-R, no close, no Excel dual-run. Next accounting-money slice: S-10 revenue/A-R + close; S-6 historical import waits for Stage-M. |
...
5. **Build now:** S-10 revenue/A/R + close. S-8b operational dashboard/360 linkage (#673), custody transfer (#674), and custody reports (#675) are live; PDF/proof polish can run as finance UX before/alongside S-10. **After 2:** real palm-registry import via SPEC-0020 path → #157 real budget gate → historical import/reconciliation.

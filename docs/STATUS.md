...
*Updated: 2026-08-08 (Owner public-site comments live-verified). Owner: Amr Ebeid.*
...
appears once as WhatsApp; only the remaining phone is rendered as a call button. The production content
...
the requested copy/contact/market values; 390px shows one WhatsApp and one distinct phone. Hosted migration
`20260808062443 owner_public_site_comments` applied
migrate-first; aggregate postflight verified the exact 120 / 5,000 / 7 figures, new About copy, contact
identity/email and East Asian markets in the one production content row. PR #1006 merged as `a11a7e0`; exact-
merge CI, db-tests and release are green, and production deployment `5806268580` completed successfully. Live
Chrome at 390px and 1,440px verified Arabic and English copy, one new-email link, zero old-email links, one
WhatsApp link, zero duplicate primary-phone call links, one distinct secondary-phone link, zero farm-area
tables, no horizontal overflow and no console/page errors.

...
| **FEAT-028** | Custody ledger & payment requests | ✅ (+ settlement via FEAT-030) | `/custody`, `/custody/request/[requestId]` | `20260629150000`/`20260629150100`; `fn_save_custody_account`, `fn_record_custody_movement`, `fn_transfer_custody`, `fn_set_expense_payment_status`, `fn_create_payment_request`, `fn_add_expense_to_request`, lifecycle RPCs, `fn_payment_request_totals`; **settlement `20260701220000`: `fn_record_payment_request_funding`, `fn_confirm_request_expense_paid`, `fn_close_payment_request`** | `CustodyForms.tsx`, `RequestLifecycle.tsx`, `lib/request-lifecycle.ts` | `102_custody_payment`, `103_payment_request`, `112_accounting_cash_custody_settlement`, `119_custody_transfer`, `request-lifecycle.test.ts` | SPEC-0018 |

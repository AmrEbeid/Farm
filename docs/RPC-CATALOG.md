...
| **RPC-051** | `fn_finalize_sale_price(p_sale,p_unit_price)` | sale,unit_price | jsonb | Set final price/total for a pending sale and post Dr A/R / Cr sales revenue once; total is exact JSON text from `20260808130000` | BR-116/117/123/125 | `sales`,`journal_entries`,`journal_lines`,`accounts` | FEAT-023/030 |
| **RPC-052** | `fn_record_sale_collection(…)` | sale,amount,occurred_at?,collected_by?,note? | jsonb | Record a partial/final customer collection and post Dr cash / Cr A/R; rejects over-collection; collected total is exact JSON text from `20260808130000` | BR-116/117/123/125 | `sale_collections`,`sales`,`journal_entries`,`journal_lines`,`accounts` | FEAT-023/030 |
